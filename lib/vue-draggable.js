...
var displayDropzones = function displayDropzones(e) {
  ...
  var itemDropzoneElement = document.createElement('tr');
  itemDropzoneElement.className = 'item-dropzone-area';

  const itemDropzoneChildElement = document.createTextNode('td');
  itemDropzoneChildElement.setAttribute("colspan", "12");

  itemDropzoneElement.appendChild(itemDropzoneChildElement);
